...
function SetQueueTable(vm) {
    ...
    var url = $("#pageUrl").val() + "Queue/LoadData";
...
function ShowSteps(id) {
    ...
    var url = $("#pageUrl").val() + "Queue/QueueSteps";
...
function ShowSteps(id) {
    ...
    $("#stepsTable").DataTable({
        ...
        "columns": [
            ...
            { "data": "postExecutionDecision", "name": "PostExecutionDecision", "autoWidth": true }
        ]
    });
...
function SuspendQueue(id) {
    ...
    var url = $("#pageUrl").val() + "Queue/ToggleSuspend";
...
function CancelQueue(id) {
    ...
    var url = $("#pageUrl").val() + "Queue/ToggleCancel";
